...
class ArtaxPrematureCoinstakeSpendTest(BitcoinTestFramework):
    ...
    def assert_spend_of_coinstake_at_height(self, height, should_accept):
        ...
        block, sig_key = create_unsigned_mpos_block(self.node, self.scratching_prevouts, next_block_time, 1000000)
        block.vtx.append(tx)
        ...
        self.remove_from_scratching_prevouts(block.prevoutStake)
...
if __name__ == '__main__':
    ArtaxPrematureCoinstakeSpendTest().main()
