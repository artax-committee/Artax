...
class ArtaxNullSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, CScript([b"\x04", CScriptNum(1000000), CScriptNum(XAX_MIN_GAS_PRICE), b"\x00", OP_CREATE]))]
