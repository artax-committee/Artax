...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see xax-dgp.py
"""
class ArtaxDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the xaxd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    ArtaxDGPActivation().main()
