...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " xax-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  xax-tx [options] <hex-tx> [commands]  Update hex-encoded xax transaction\n" +
            "or:     xax-tx [options] -create [commands]   Create hex-encoded xax transaction\n" +
            "\n";
