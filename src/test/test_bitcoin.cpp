...
////////////////////////////////////////////////////////////// xax
        ...
        globalState = std::unique_ptr<ArtaxState>(new ArtaxState(dev::u256(0), ArtaxState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::xaxTestNetwork)));
