...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // xax
        hashUTXORoot.SetNull(); // xax
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //xax
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //xax
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //xax
    {
