...
#include "genesis/xaxMainNetwork.cpp"
#include "genesis/xaxTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::xaxMainNetwork: return c_genesisInfoArtaxMainNetwork;
	case Network::xaxTestNetwork: return c_genesisInfoArtaxTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::xaxMainNetwork: return c_genesisStateRootArtaxMainNetwork;
	case Network::xaxTestNetwork: return c_genesisStateRootArtaxTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
