...
////////////////////////////////////////////////////////////// // xax
	void setArtaxSchedule(EVMSchedule _xaxSchedule) const { xaxSchedule = _xaxSchedule; }

	EVMSchedule& getArtaxSchedule() const { return xaxSchedule; }
...
private:
	...
	mutable EVMSchedule xaxSchedule; // xax
