...
private:
    ...
    QLabel *labelScratchingIcon = nullptr;
    ...
    ArtaxVersionChecker *xaxVersionChecker = nullptr;
...
private Q_SLOTS:
    ...
    void toggleHidden();
    /** Update scratching icon **/
    void updateScratchingIcon();
