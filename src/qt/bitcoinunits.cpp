...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XAX");
    case mBTC: return QString("mXAX");
    case uBTC: return QString::fromUtf8("μXAX (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Artaxs");
    case mBTC: return QString("Milli-Artaxs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Artaxs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
