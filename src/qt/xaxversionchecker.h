#ifndef XAXVERSIONCHECKER_H
#define XAXVERSIONCHECKER_H
...
class ArtaxVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit ArtaxVersionChecker(QObject *parent = 0);
    ~ArtaxVersionChecker();
