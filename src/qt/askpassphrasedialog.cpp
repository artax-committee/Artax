    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ...
            break;
        case UnlockScratching:
            ui->scratchingCheckBox->setChecked(true);
            ui->scratchingCheckBox->show();
...
{
    this->model = _model;
    if(model) ui->scratchingCheckBox->setChecked(model->getWalletUnlockScratchingOnly() || mode == UnlockScratching);
}
...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR XAXS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         ...
                                         "your xaxs from being stolen by malware infecting your computer.").arg(tr(PACKAGE_NAME)) +
                                         "<br><br><b>" +
    ...
    case Unlock:
        ...
        {
            model->setWalletUnlockScratchingOnly(ui->scratchingCheckBox->isChecked());
            QDialog::accept(); // Success
        }
        break;
    case Decrypt:
